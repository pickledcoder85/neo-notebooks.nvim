...
- Phase 6 (Error/Notify Policy): in progress (command + keymap boundary notify migration expanded across split/toggle/guard, preview/editor, run-request errors including run-all/subset summaries, and restart/stats flows).
