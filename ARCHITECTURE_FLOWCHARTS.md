...
- Phase 7 (Kernel/Session Robustness): in progress (state owner + transitions + kernel controls + queue-pause dispatch gating + bounded dispatch-time recovery landed; deeper recovery tests and status-surface polish pending).
