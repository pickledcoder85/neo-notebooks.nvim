...
- Current migration status: started for output print/collapse, cell yank, split/toggle actions, insert-guard `<CR>` warnings, and containment guard-warning flows (command/keymap boundaries own notifications).
